...
def comsol_to_gmsh(comsol_filename:str,gmsh_filename:str) -> Dict[str,np.array]:
    """
    ...
    with open('comsol_filename','r') as f:
        ...
        value_reg = re.compil("\((.*)\)") #extracts the data value name
        # open file and read
        current_list = None
        for l in f.readlines():
            if l[0] =='%':
                ...
                if l == '% Coordinates\n':
                    ...
                    value_name = value_reg.findall(l).group(1) 
