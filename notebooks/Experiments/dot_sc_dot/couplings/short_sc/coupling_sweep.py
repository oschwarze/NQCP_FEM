...
model_states_file = "/mnt/c/Users/olisc/NQCP/NQCP_FEM/notebooks/Experiments/dot_sc_dot/couplings/short_sc/model_states_sd.pkl"
...
def system_update(mu_sc_val):
    ...
    return syst.perturbative_selection_couplings(model_basis,solver,4700*E0,(-300*E0,300*E0),method='signed')
...
if __name__ == '__main__':
    ...
    mu_sc_values = np.linspace(4000,6000,128)*E0 # Log mu sweet_spot zoom
